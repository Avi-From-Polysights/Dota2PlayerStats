...
export const TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    title: "App sections",
    body:
      "Switch tabs anytime: Analyze for single-hero stats, All Heroes for cached cross-hero comparison, Hero Builder for skill/item build planning, Tools for batch jobs, and Changelogs for release notes.",
  },
  {
    id: "tools",
